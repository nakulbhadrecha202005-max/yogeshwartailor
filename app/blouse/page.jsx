            ...
            >
              <tbody>
                <tr className="h-30 ">
                  ...
                  <td className="pt-4 pb-4 px-12">
                    <div className="flex items-center gap-6">
                      <button className="py-2 px-6   text-[#a8aabc]   border  border-[#4a4e69] rounded-xl font-bold shadow-lg transition-all hover:border-[#d4af37] hover:text-[#d4af37] hover:text-[#1a1c23] active:scale-95">
                        Dress
                      </button>

                      <button className="py-2 px-6 bg-[#343a40] text-[#d4af37] border border-[#d4af37]  rounded-xl font-bold shadow-md transition-all   hover:bg-[#d4af37] active:scale-95">
                        Blouse
                      </button>
                    </div>
                  </td>
                ...
                <tr className="h-8">
                  ...
                  <td className=" border-gray-500">
                    <div className="textInputWrapper2">
                      <input type="text" className="textInput2" />
                    </div>
                  </td>
                </tr>
                ...
                <tr className="h-8">
                  <td className="w-10"></td>
                  <td className=" border-gray-500">
                    <div className="textInputWrapperb3">
                      <input type="text" className="textInputb3" />
                    </div>
                  </td>
                </tr>
                <tr className="h-8">
                  ...
                  <td colSpan={2} className=" border-gray-500">
                    <div className="flex gap-2">
                      <div className="textInputWrapper7">
                        <input type="text" className="textInput7" />
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                <tr className="h-8">
                  ...
                  <td colSpan={2} className="border-gray-500">
                    <div className="flex gap-2">
                      <div className="textInputWrapper3b">
                        <input
                          type="text"
                          placeholder="4th "
                      ...
                      <div className="textInputWrapper3b">
                        <input type="text" className="textInput3b" />
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                <tr className="h-8">
                  <td className="w-10"></td>
                  <td className=" border-gray-500">
                    <div className="textInputWrapper9">
                      <input
                        type="text"
                        placeholder="9"
                ...
                <tr className="h-8">
                  ...
                  <td colSpan={2} className=" border-gray-500">
                    <div className="flex gap-2">
                      <div className="textInputWrapper10">
                        <input
                          type="text"
                          placeholder="10"
                  ...
                  <td colSpan={2} className=" border-gray-500">
                    <div className="flex gap-2">
                      <div className="textInputWrapper11">
                        <input type="text" className="textInput11" />
                      </div>
                      <div className="textInputWrapper12">
                        <input
                          type="text"
                          placeholder="10"
                ...
                <tr className="h-8">
                  ...
                  <td className=" border-gray-500">
                    <div className="mt-10 mb-5 flex items-center gap-3">
                      ...
                      <button className="flex items-center gap-2 px-4 py-1.5 bg-[#fffff] text-gray-300 text-sm font-semibold border border-gray-300 rounded-md shadow-sm hover:shadow-md hover:bg-gray-50 hover:border-blue-200 transition-all duration-200 active:scale-95">
                      ...
                      {/* Reset Button */}
                      <button className="px-4 py-1.5 ml-10 border border-gray-500 text-sm text-gray-500 font-medium rounded-md hover:bg-gray-100 hover:text-gray-800 transition-colors duration-200 active:bg-gray-200">
                        Reset
                      </button>
                    </div>
                  </td>
