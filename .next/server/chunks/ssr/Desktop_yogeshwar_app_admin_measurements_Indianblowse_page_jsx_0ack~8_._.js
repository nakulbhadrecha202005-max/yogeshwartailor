module.exports=[5173,a=>{"use strict";var b=a.i(10361),c=a.i(35130),d=a.i(22913),e=a.i(58692);a.i(75804);var f=a.i(76734),g=a.i(71890),h=a.i(54137),i=a.i(60812);let j=()=>{let a=(0,d.useRouter)(),j=(0,d.useSearchParams)(),k=j?.get("id")||"",[l,m]=(0,c.useState)(""),[n,o]=(0,c.useState)(""),[p,q]=(0,c.useState)(""),r=(0,c.useRef)(null),s=(0,c.useRef)(null),t=(0,c.useRef)(!1),[u,v]=(0,c.useState)([]),[w,x]=(0,c.useState)({customer_id:"",customer_Number:"",customer_Name:"",TypeCloth:"blouse",bust:"",waist:"",shoulder:"",sleeveLength:"",blouseLength:"",neckDepthFront:"",neckDepthBack:"",armRound:"",specialNotes:"",m7:"",m8:"",m9:"",m10:"",m11:"",m12:"",m13:"",m14:"",m15:"",m16:"",m17:"",m18:"",m19:"",m20:"",m21:"",m22:"",m23:""}),y=a=>{let{name:b,value:c}=a.target;x(a=>({...a,[b]:c}))},[z,A]=(0,c.useState)(""),[B,C]=(0,c.useState)(null);(0,c.useEffect)(()=>{k&&(async()=>{try{let a=(0,h.doc)(e.db,"customersName",k),b=await (0,g.getDoc)(a);b.exists()?m({id:b.id,...b.data()}):o("No such document!")}catch(a){o("Error : "+a.message)}})()},[k]),(0,c.useEffect)(()=>{l&&x(a=>({...a,customer_id:l.id,customer_Name:l.customerName,customer_Number:l.customerNumber}))},[l]);let D=async a=>{a.preventDefault();try{await (0,g.setDoc)((0,h.doc)(e.db,"customerMeasurement",l.id),{name:l.customerName,phone:l.customerNumber,customer_id:w.customer_id},{merge:!0}),await (0,g.addDoc)((0,f.collection)(e.db,"customerMeasurement",l.id,"measurements"),{...w,createdAt:new Date}),x({customer_id:l.id,customer_Name:l.customerName,customer_Number:l.customerNumber,TypeCloth:"dress",bust:"",waist:"",shoulder:"",sleeveLength:"",blouseLength:"",neckDepthFront:"",neckDepthBack:"",armRound:"",specialNotes:"",m7:"",m8:"",m9:"",m10:"",m11:"",m12:"",m13:"",m14:"",m15:""}),alert("Record saved successfully!")}catch(a){console.error("Error saving document: ",a),o("Error: "+a.message)}};(0,c.useEffect)(()=>{let a=(0,g.onSnapshot)((0,i.collectionGroup)(e.db,"measurements"),a=>{v(a.docs.map(a=>({id:a.id,...a.data()})))});return()=>a()},[]);let E=async(a,b)=>{if(!a||!b)return void o("Error: Missing ID for deletion");try{await (0,g.deleteDoc)((0,h.doc)(e.db,"customerMeasurement",b,"measurements",a)),await (0,g.deleteDoc)((0,h.doc)(e.db,"customerMeasurement",b)),x({customer_id:l.id,customer_Number:l.customerNumber,customer_Name:l.customerName,TypeCloth:"dress",bust:"",waist:"",shoulder:"",sleeveLength:"",blouseLength:"",neckDepthFront:"",neckDepthBack:"",armRound:"",specialNotes:"",m7:"",m8:"",m9:"",m10:"",m11:"",m12:"",m13:"",m14:"",m15:""}),o("Record deleted successfully"),C(null),q(""),window.location.hash=""}catch(a){console.error("Delete Error:",a),o("Error : "+a.message)}},F=()=>u.filter(a=>a.customer_Name?.toLowerCase().includes(z?.toLowerCase())),G=a=>{q(a.id),x({customer_id:a?.customer_id||"",customer_Number:a?.customer_Number||"",customer_Name:a?.customer_Name||"",TypeCloth:a?.TypeCloth||"dress",bust:a?.bust||"",waist:a?.waist||"",shoulder:a?.shoulder||"",sleeveLength:a?.sleeveLength||"",blouseLength:a?.blouseLength||"",neckDepthFront:a?.neckDepthFront||"",neckDepthBack:a?.neckDepthBack||"",armRound:a?.armRound||"",specialNotes:a?.specialNotes||"",m7:a?.m7||"",m8:a?.m8||"",m9:a?.m9||"",m10:a?.m10||"",m11:a?.m11||"",m12:a?.m12||"",m13:a?.m13||"",m14:a?.m14||"",m15:a?.m15||""})};(0,c.useEffect)(()=>{let a=()=>{window.location.hash.includes("modal-view-measure")||x(a=>({...a,TypeCloth:"blouse"}))};return window.addEventListener("hashchange",a),()=>window.removeEventListener("hashchange",a)},[]);let H=async()=>{if(!p||!w.customer_id)return void o("No record selected to update");try{let a=(0,h.doc)(e.db,"customerMeasurement",w.customer_id,"measurements",p);await (0,g.updateDoc)(a,{...w,lastUpdated:new Date().toISOString()}),o("Record updated successfully!"),x({customer_id:l.id,customer_Name:l.customerName,customer_Number:l.customerNumber,TypeCloth:"dress",bust:"",waist:"",shoulder:"",sleeveLength:"",blouseLength:"",neckDepthFront:"",neckDepthBack:"",armRound:"",specialNotes:"",m7:"",m8:"",m9:"",m10:"",m11:"",m12:"",m13:"",m14:"",m15:""}),q(""),window.location.hash="#"}catch(a){console.error("Update Error:",a),o("Error Updating: "+a.message)}},I=a=>({A:"bg-red-800",B:"bg-blue-800",C:"bg-green-800",D:"bg-yellow-700",E:"bg-indigo-800",F:"bg-purple-800",G:"bg-pink-800",H:"bg-orange-700",I:"bg-teal-800",J:"bg-cyan-800",K:"bg-lime-700",L:"bg-amber-700",M:"bg-emerald-800",N:"bg-violet-800",O:"bg-fuchsia-800",P:"bg-rose-950",Q:"bg-sky-800",R:"bg-stone-700",S:"bg-neutral-700",T:"bg-zinc-700",U:"bg-gray-700",V:"bg-slate-700",W:"bg-red-600",X:"bg-blue-600",Y:"bg-green-600",Z:"bg-yellow-600"})[a?.charAt(0).toUpperCase()||"U"]||"bg-slate-700";(0,c.useEffect)(()=>{},[]);let J=a=>{if(!r.current)return;let b=r.current;if(t.current)b.stop(),setTimeout(()=>{s.current=a;try{b.start()}catch(a){console.log("Start error:",a)}},200);else{s.current=a;try{b.start()}catch(a){console.log("Start error:",a)}}},K=()=>{r.current&&(t.current&&r.current.stop(),s.current=null)};return(0,b.jsxs)("main",{className:"max-w-7xl overflow-x-hidden px-4 sm:px-6 lg:px-8 py-10 md:py-14",children:[(0,b.jsx)("style",{children:`
        :root {
            --midnight: #0B0F19;
            --berry: #581C1E;
            --off-white: #F9F7F5;
