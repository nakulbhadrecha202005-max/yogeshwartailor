...
"[project]/app/admin/Managecomments/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const page = ()=>{
    ...
    const handleDelete = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["deleteDoc"])(doc(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"], "comments", targetId));
        } catch (error) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "page.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$dfb5c973$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(auth, {
            ...
            const fetchData = {
                "page.useEffect.fetchData": async ()=>{
                    ...
                    const result = querySnapshot.docs.map({
                        "page.useEffect.fetchData.result": (doc1)=>({
                                id: doc1.id,
                                ...doc1.data()
                            })
                ...
                "page.useEffect.fetchComments": async ()=>{
                    try {
                        ...
                        const commentsData = querySnapshot.docs.map({
                            "page.useEffect.fetchComments.commentsData": (doc1)=>({
                                    id: doc1.id,
                                    ...doc1.data()
                                })
...
//# sourceMappingURL=app_admin_Managecomments_page_jsx_0v.5jdi._.js.map