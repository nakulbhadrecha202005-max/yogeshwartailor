...
"[project]/app/admin/measurements/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PageContent = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageContent.useEffect": ()=>{
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2d$dfb5c973$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__z__as__onAuthStateChanged$3e$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "PageContent.useEffect.unsubscribe": (currentUser)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageContent.useEffect": ()=>{
            const fetchUsers = {
                "PageContent.useEffect.fetchUsers": async ()=>{
                    ...
                    const data = querySnapshot.docs.map({
                        "PageContent.useEffect.fetchUsers.data": (doc)=>({
                                id: doc.id,
                                ...doc.data()
                            })
                    }["PageContent.useEffect.fetchUsers.data"]);
                    //console.log("Fetched Users:", data);
                    setUser(data);
                }
            }["PageContent.useEffect.fetchUsers"];
            fetchUsers();
        }
    }["PageContent.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageContent.useEffect": ()=>{
            ...
            const matchUser = User.find({
                "PageContent.useEffect.matchUser": (U)=>U.email === authuser.email
            }["PageContent.useEffect.matchUser"]);
            if (!matchUser) {
                router.push("/login");
            }
        }
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        fileName: "[project]/app/admin/measurements/page.jsx",
                                        lineNumber: 72,
                                        columnNumber: 17
...
_s(PageContent, "7s6hdprRLxH9ESDrZs6HQsEkX0c=", false, function() {
    return [
...
//# sourceMappingURL=app_admin_measurements_page_jsx_0qg76_c._.js.map