        ...
        "page.useEffect": ()=>{
            const checkRedirect = {
                "page.useEffect.checkRedirect": async ()=>{
                    try {
                        const result = await getRedirectResult(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$firebase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"]);
                        if (result) {
                            router.push("/");
                        }
                    } catch (error) {
...
//# sourceMappingURL=_0j9tnft._.js.map